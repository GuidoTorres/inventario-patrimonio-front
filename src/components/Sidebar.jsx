...
const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    if (path.startsWith("/proceso")) {
      setSelectedKey("/proceso");
    } else if (path.startsWith("/consulta")) {
      setSelectedKey("/consulta");
    } else if (path.startsWith("/configuracion")) {
      setSelectedKey("/configuracion");
    } else if (path.startsWith("/mantenimiento")) {
      setSelectedKey("/mantenimiento");
    } else if (path.startsWith("/sistema")) {
      setSelectedKey("/sistema");
    } else {
      setSelectedKey(path);
    }
  }, [location]);
